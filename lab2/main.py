        ...
        if choice == "1":
            ...
            while True:
                ...
                if faculty_choice == "1":
                    ...
                    if 0 <= faculty_index < len(university.faculties):
                        faculty = university.faculties[faculty_index]
                        current_students = [student for student in faculty.get_current_students() if not student.is_graduated]
                    ...
                    if 0 <= faculty_index < len(university.faculties):
                        faculty = university.faculties[faculty_index]
                        graduates = [student for student in faculty.get_graduates() if student.is_graduated]
